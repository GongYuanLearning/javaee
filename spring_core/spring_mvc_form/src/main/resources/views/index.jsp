...
<div class="center_con clearfix">
    <ul class="subnav fl">
        <c:forEach items="${categories}" var="category">
            <li><a href="${ctx}/list?category=${category.id}" class="fruit">${category.name}</a></li>
        </c:forEach>
...
<c:forEach items="${productsByCategories}" var="entry">
        <div class="list_model">
            <div class="list_title clearfix">
                <h3 class="fl" id="model01">${entry.key}</h3>
                ...
                <ul class="goods_list fl">
                    <c:forEach items="${entry.value}" var="product">
                        <li>
                            ...
                            <a href="#"><img width="180" height="80" src="${product.imagePath}"></a>
